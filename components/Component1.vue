  ...
  <header class="header">
    <div class="header-container">
      ...
      <div class="logo-and-menu">
        <div class="menu-icon-and-text hover">
      ...
      <div class="search-bar">
        <div class="search-input-container">
          <input
            type="text"
            placeholder="Bir ürün, spor veya marka arayın..."
            class="search-input"
          />
      ...
      <div class="header-links">
        <ul class="links">
          <li class="hover">
            <a href="#">
              <img src="/assets/question.svg" alt="Question Icon" class="icon" />
              <span>Bize Ulaşın</span>
            </a>
          </li>
          <li class="hover">
            <a href="#">
              <img src="/assets/market.svg" alt="Market Icon" class="icon" />
          ...
          <li class="hover">
            <a href="#">
              <img src="/assets/cart.svg" alt="Cart Icon" class="icon" />
              <span>Sepetim</span>
            </a>
          </li>
        </ul>
